...
typography:
  ...
  body:    { fontFamily: "KaiTi, STKaiti, sans-serif", cqw: 0.95, weight: 500, lineHeight: 1.6 }
  body-strong:{ fontFamily: "KaiTi, STKaiti, sans-serif", cqw: 0.95, weight: 600, lineHeight: 1.5 }
  meta:    { fontFamily: "KaiTi, STKaiti, sans-serif", cqw: 0.78, weight: 600, lineHeight: 1.45 }
  # — display ramp (Fredoka One / Fredoka 600 — single weight, never italic) —
  badge:   { fontFamily: "Caveat, KaiTi, STKaiti, sans-serif", cqw: 0.9, tracking: "0.02em" }
  label-display:{ fontFamily: "Caveat, KaiTi, STKaiti, sans-serif", cqw: 1.3, lineHeight: 1.3, tracking: "0.02em" }
  subtitle:{ fontFamily: "Caveat, KaiTi, STKaiti, sans-serif", cqw: 1.8, lineHeight: 1.2, tracking: "0.02em" }
  quote:   { fontFamily: "Caveat, KaiTi, STKaiti, sans-serif", cqw: 2.6, lineHeight: 1.35 }
  title:   { fontFamily: "Caveat, KaiTi, STKaiti, sans-serif", cqw: 3.0, lineHeight: 1.15, tracking: "0.02em" }
  headline:{ fontFamily: "Caveat, KaiTi, STKaiti, sans-serif", cqw: 4.5, lineHeight: 1.1, tracking: "0.02em" }
  display: { fontFamily: "Caveat, KaiTi, STKaiti, sans-serif", cqw: 6.5, lineHeight: 1.1, tracking: "0.02em" }
